# Usage: manage.py migrateSettledCases.py <username> <email>
...
DATASET_SLUG = "pugetsoundcases"
DATASET_ID = "pugetsoundcases"
LOCATION_TYPE = "settled-cases"

json_data = requests.get('https://raw.githubusercontent.com/mapseed/data/master/Settled-Cases-csv-Geocoded-File.geojson').json()
