...
class Master (models.Model):
    ...
    agua_calidad = models.CharField( blank=True, null=True)
    biodiversidad_especies = models.CharField( blank=True, null=True)
    cuerpo_agua = models.CharField( blank=True, null=True)
    datetime_field = models.CharField( blank=True, null=True)
    estado_agua_clara = models.CharField( blank=True, null=True)
    estado_agua_registro = models.CharField( blank=True, null=True)
    estado_color_agua = models.CharField( blank=True, null=True)
    estado_materiales_cuales = models.CharField( blank=True, null=True)
    estado_materiales_flotantes = models.CharField( blank=True, null=True)
    estado_olores_agua = models.CharField( blank=True, null=True)
    entorno_cuerpo_agua = models.CharField( blank=True, null=True)
    fuente_contaminacion_cercana = models.CharField( blank=True, null=True)
    fuentes_opcion = models.CharField( blank=True, null=True)
    lluvias_observacion = models.CharField( blank=True, null=True)
    lluvias_observacion_opcion = models.CharField( blank=True, null=True)
    location_type = models.CharField( blank=True, null=True)
    nivel_agua_cuerpo = models.CharField( blank=True, null=True)
    private_address = models.CharField( blank=True, null=True)
    referencia_cercana = models.CharField( blank=True, null=True)
    reportes_estado_area = models.CharField( blank=True, null=True)
    subbasin_name = models.CharField( blank=True, null=True)
    subbasin_name_nombre = models.CharField( blank=True, null=True)
    vegetacion_cuerpo_agua = models.CharField( blank=True, null=True)
    vegetacion_cuerpo_agua_option = models.CharField( blank=True, null=True)
    vegetacion_margenes_cuerpo = models.CharField( blank=True, null=True)
    vegetacion_opcion = models.CharField( blank=True, null=True)
    vientos_fuertes = models.CharField( blank=True, null=True)
    visitas = models.CharField( blank=True, null=True)
