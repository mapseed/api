...
# RUN git clone https://github.com/smartercleanup/api.git && cd api && git checkout master-upstream-updates && cd -
RUN git clone https://github.com/smartercleanup/api.git && cd api && git checkout staging-new-features && cd -
